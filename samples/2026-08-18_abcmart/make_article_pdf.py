...
def main():
    ...
    figs = {
        "1": ("ユニクロ32店・無印良品19店に対しABCマートは5店「日系専門店チェーンのベトナム店舗数」（出所）各社公式店舗一覧・公表資料をもとにInfoBank作成。ユニクロは2026年7月時点、無印良品は2026年8月時点、ABCマートは新店を含む。", "figure1.png"),
        "2": ("韓国317店に対しベトナムは4店、今回の開業で5店に「ABCマートの海外店舗数（2026年3月末時点）」（出所）エービーシー・マート「2027年2月期第1四半期決算」をもとにInfoBank作成。", "figure2.png"),
    }
