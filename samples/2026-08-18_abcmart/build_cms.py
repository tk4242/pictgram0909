...
FIG_CAP = {
    "1": "【ABCマートの海外店舗数（2026年3月末時点）】（出所）エービーシー・マート「2027年2月期第1四半期決算」をもとにInfoBank作成。",
    "2": "【日系専門店チェーンのベトナム店舗数】（出所）各社公表資料をもとにInfoBank作成。ユニクロは2026年7月時点、無印良品は2025年11月時点、ABCマートは新店を含む。",
}
